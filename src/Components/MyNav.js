...
function MyNav() {
    ...
    return (
        <div className={`w-full h-nav fixed z-10 flex justify-between items-center ${toggle && "bg-blue-600"}`}>
            ...
            <div className={`h-full w-1/3 flex justify-end items-center`}>
                ...
                <nav className={`hidden md:flex w-full h-full mr-10 items-center justify-around`}>
